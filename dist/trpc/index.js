...
exports.appRouter = (0, trpc_1.router)({
    ...
    saveClientInfo: trpc_1.publicProcedure
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 4:
                    error_1 = _c.sent();
                    console.error('Error saving client info:', error_1);
    ...
    getInfiniteProducts: trpc_1.publicProcedure
        ...
        .query(function (_a) { return __awaiter(void 0, [_a], void 0, function (_b) {
        var query, cursor, sort, limit, category, subcategory, payload, whereClause, page, _c, items, hasNextPage, nextPage;
        var input = _b.input;
        return __generator(this, function (_d) {
            switch (_d.label) {
                case 0:
                    query = input.query, cursor = input.cursor;
                    sort = query.sort, limit = query.limit, category = query.category, subcategory = query.subcategory;
                    return [4 /*yield*/, (0, get_payload_1.getPayloadClient)()];
                case 1:
                    payload = _d.sent();
                    whereClause = {
